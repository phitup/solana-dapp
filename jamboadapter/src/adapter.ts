...
interface JamboWalletEvents {
  connect(...args: unknown[]): unknown;
  disconnect(...args: unknown[]): unknown;
}

interface JamboWallet extends EventEmitter<JamboWalletEvents> {
  isJambo?: boolean;
...
interface JamboWalletWindow extends Window {
  jambo?: JamboWallet;
}

declare const window: JamboWalletWindow;

export interface JamboWalletAdapterConfig {}

export const JamboWalletName = "Jambo" as WalletName<"Jambo">;

export class JamboWalletAdapter extends BaseMessageSignerWalletAdapter {
  name = JamboWalletName;
  ...
  private _wallet: JamboWallet | null;
