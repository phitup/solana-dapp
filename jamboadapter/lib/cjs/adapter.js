...
class JamboWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
  constructor(config = {}) {
    super();
    this.name = exports.JamboWalletName;
    this.url = "https://www.jambo.technology/";
    this.icon =
    ...
    if (
      ...
      (0, wallet_adapter_base_1.scopePollingDetectionStrategy)(() => {
        var _a;
        if (
          (_a = window.jambo) === null || _a === void 0 ? void 0 : _a.isJambo
        ) {
  ...
  get connected() {
    var _a;
    return !!((_a = this._wallet) === null || _a === void 0
      ? void 0
      : _a.isConnected);
  }
  get readyState() {
    ...
    return __awaiter(this, void 0, void 0, function* () {
      ...
      if (wallet) {
        ...
        try {
          ...
          this.emit(
            "error",
            new wallet_adapter_base_1.WalletDisconnectionError(
              error === null || error === void 0 ? void 0 : error.message,
              error
            )
          );
  ...
  signAllTransactions(transactions) {
    return __awaiter(this, void 0, void 0, function* () {
      try {
        ...
        try {
          return (
            (yield wallet.signAllTransactions(transactions)) || transactions
          );
        } catch (error) {
          throw new wallet_adapter_base_1.WalletSignTransactionError(
            error === null || error === void 0 ? void 0 : error.message,
